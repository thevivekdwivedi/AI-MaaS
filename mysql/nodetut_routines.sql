...
--
-- Temporary view structure for view `supplier_enablement`
--

DROP TABLE IF EXISTS `supplier_enablement`;
/*!50001 DROP VIEW IF EXISTS `supplier_enablement`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `supplier_enablement` AS SELECT 
 1 AS `Prospect_ID`,
 1 AS `Supplier_Name`,
...
/*!50001 CREATE VIEW `new_view` AS SELECT 
 ...
 1 AS `Supplier_Name`,
 1 AS `Enablement_Strategy`,
 1 AS `Overall_Enablement_Strategy`,
 1 AS `Initial_Month`,
 1 AS `Initial_Year`,
 1 AS `Match_Current_Status`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `prospect_match_rate`
--

DROP TABLE IF EXISTS `prospect_match_rate`;
/*!50001 DROP VIEW IF EXISTS `prospect_match_rate`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `prospect_match_rate` AS SELECT 
 1 AS `Prospect_ID`,
 1 AS `Spend`,
 1 AS `PO`,
 1 AS `SMP`,
...
--
-- Temporary view structure for view `prospect_listing`
--

DROP TABLE IF EXISTS `prospect_listing`;
/*!50001 DROP VIEW IF EXISTS `prospect_listing`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `prospect_listing` AS SELECT 
 1 AS `ID`,
 1 AS `Prospect`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `overall_supplier_enablement`
--

DROP TABLE IF EXISTS `overall_supplier_enablement`;
/*!50001 DROP VIEW IF EXISTS `overall_supplier_enablement`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `overall_supplier_enablement` AS SELECT 
 1 AS `Supplier`,
 1 AS `SMP`,
 1 AS `Strategy`,
 1 AS `Prospects`*/;
...
--
-- Final view structure for view `supplier_enablement`
--
...
/*!50001 VIEW `supplier_enablement` AS select `unmatched_suppliers`.`Prospect_ID` AS `Prospect_ID`,`unmatched_suppliers`.`Prospect_Supplier_Name` AS `Supplier_Name`,`unmatched_suppliers`.`Enablement_Strategy` AS `Enablement_Strategy`,`unmatched_suppliers`.`SMP_USD` AS `SMP` from `unmatched_suppliers` order by `SMP` desc limit 20 */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `supplier_match` AS select `unmatched_suppliers`.`Prospect_ID` AS `ID`,`unmatched_suppliers`.`Prospect_Supplier_Name` AS `Supplier`,`unmatched_suppliers`.`Match_Current_Status` AS `Match_Current_Status`,`unmatched_suppliers`.`Initial_time_MMM` AS `Initial_Month`,`unmatched_suppliers`.`Initial_time_YYYY` AS `Initial_Year` from `unmatched_suppliers` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `new_view` AS select `unmatched_suppliers`.`Prospect_ID` AS `Prospect_ID`,`unmatched_suppliers`.`Prospect_Supplier_Name` AS `Supplier_Name`,`unmatched_suppliers`.`Enablement_Strategy` AS `Enablement_Strategy`,`unmatched_suppliers`.`Overall_Enablement_Strategy` AS `Overall_Enablement_Strategy`,`unmatched_suppliers`.`Initial_time_MMM` AS `Initial_Month`,`unmatched_suppliers`.`Initial_time_YYYY` AS `Initial_Year`,`unmatched_suppliers`.`Match_Current_Status` AS `Match_Current_Status` from `unmatched_suppliers` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
--
-- Final view structure for view `prospect_match_rate`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `prospect_match_rate` AS select `unmatched_suppliers`.`Prospect_ID` AS `Prospect_ID`,sum(`unmatched_suppliers`.`Spend_USD`) AS `Spend`,sum(`unmatched_suppliers`.`PO_Count`) AS `PO`,sum(`unmatched_suppliers`.`SMP_USD`) AS `SMP`,count(0) AS `Count`,`unmatched_suppliers`.`Initial_time_MMM` AS `Initial_Month`,`unmatched_suppliers`.`Initial_time_YYYY` AS `Initial_Year`,`unmatched_suppliers`.`Match_Current_Status` AS `Match_Current_Status` from `unmatched_suppliers` group by `unmatched_suppliers`.`Prospect_ID`,`Initial_Month`,`Initial_Year`,`unmatched_suppliers`.`Match_Current_Status` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `prospect_listing`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `prospect_listing` AS select `prospect_meta_data`.`Prospect_ID` AS `ID`,`prospect_meta_data`.`Prospect_Name` AS `Prospect` from `prospect_meta_data` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
--
-- Final view structure for view `overall_supplier_enablement`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `overall_supplier_enablement` AS select `unmatched_suppliers`.`Prospect_Supplier_Name` AS `Supplier`,sum(`unmatched_suppliers`.`SMP_USD`) AS `SMP`,`unmatched_suppliers`.`Overall_Enablement_Strategy` AS `Strategy`,count(`unmatched_suppliers`.`Prospect_ID`) AS `Prospects` from `unmatched_suppliers` group by `unmatched_suppliers`.`Prospect_Supplier_Name` order by sum(`unmatched_suppliers`.`SMP_USD`) desc limit 20 */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2017-07-28  1:38:10
